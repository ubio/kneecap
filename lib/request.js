...
module.exports = function requestConstructor(received, connection) {
    const request = {
        ...
        encapsulated: null,
        is204Allowed: false,
        getRequestHeaders: () => {throw new Error('Request headers not available');}, // sync
        getRequestBody: () => {return Promise.resolve();}, // async
    };
            ...
            request.getRequestBody = () => {
                return Promise.resolve()
                    .then(() => {
                        ...
                        if (endsWith(preview, BODY_PREVIEW_SEPARATOR)) {
